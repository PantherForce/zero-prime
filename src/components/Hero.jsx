...
const Hero = () => {
  const heroDescription = `The only subscription that gives you zero benefits, no rewards, and absolutely no purpose except to prove that you can afford it.`;
        ...
        <div className="container relative z-20 px-4 mx-auto overflow-hidden py-36 sm:px-0">
          <div className="text-center">
            ...
            <motion.p
              ...
              className="inline-flex items-center gap-2 px-3 py-2 mb-2 text-xs rounded-full select-none bg-primaryColor/5 text-black ring-1 ring-primaryColor/10"
            >
              {/* Animated Pulse Icon */}
          ...
          {/* <div className="absolute bg-cover bottom-0 left-auto -z-20 h-[750px]   right-0">
            <AnimatedSVG />
          </div> */}
